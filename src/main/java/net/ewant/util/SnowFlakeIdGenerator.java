...
public class SnowFlakeIdGenerator {
    ...
    public static class Factory {
        ...
        public SnowFlakeIdGenerator create(long idcId, long machineId) {
            return new SnowFlakeIdGenerator(this.idcBitNum, this.machineBitNum, idcId, machineId);
        }
    }
    ...
    private SnowFlakeIdGenerator(int idcBitNum, int machineBitNum, long idcId, long machineId) {
